...
| Larry acompañante (narra desde fuera, nunca juega) | Global | Sin confirmar | Ya existen poses (`larry_festejo`, `larry_idle_1/2`, `larry_camina_1-4`, el set fotorrealista `larry_foto_*`) que podrían servir sin arte nuevo — no se probó ninguna en este contexto todavía |
