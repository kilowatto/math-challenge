...
Todo país‑alvo estrutura a educação matemática com sua própria lógica: domínios por série (EUA), key stages e anos (Reino Unido), campos formativos e fases (reforma de 2022 do México), competências específicas e ciclos (LOMLOE da Espanha), cycles e socle commun (França), Bildungsstandards e Klassenstufen com rastreamento precoce Gymnasium/Hauptschule (Alemanha), unidades temáticas e anos (BNCC do Brasil) e ciclos de aprendizagens essenciais (Portugal). As idades de início típicas são razoavelmente alinhadas (idade 6 = série/ano/grade/klasse 1 quase em todo lugar), mas **a idade em que o mesmo tema surge diverge em 1–3 anos entre os países**: frações formais aparecem entre 6 e 9 anos, números negativos entre 9 e 12 anos e álgebra formal entre 10 e 14 anos. A Alemanha ainda divide as trajetórias dos estudantes (Gymnasium vs. Realschule/Hauptschule) a partir dos 10 anos, mais cedo que qualquer outro país‑alvo. A proposta central aqui é uma **escada interna de 11 faixas, neutra em relação a países**, ancorada em conteúdo dominado em vez de idade ou série escolar, com nomes em 5 idiomas e uma tabela de equivalência aproximada por país para contexto de pais e professores — sem vincular o aplicativo a nenhum currículo nacional específico.
...
| Idade típica | Grau (EUA) | Ano (UK) | Grau/fase (MX) | Classe (FR) (ciclo) | Nível de classe (DE) | Ano (BR) |
|---|---|---|---|---|---|---|
| 4–5 | Pre‑K | Reception | Pré‑escolar 2 | Moyenne section (C1) | Kindergarten | Educação Infantil |
| 5–6 | Kindergarten | Year 1 | Pré‑escolar 3 (Fase 2) | Grande section (C1) | Vorschule/Kl. 1 | Educação Infantil / 1º ano |
| 6–7 | Série 1 | Year 2 | 1ª primária (Fase 3) | CP (C2) | Klasse 1 | 1º ano EF |
| 7–8 | Série 2 | Year 3 | 2ª primária (Fase 3) | CE1 (C2) | Klasse 2 | 2º ano EF |
| 8–9 | Série 3 | Year 4 | 3ª primária (Fase 4) | CE2 (C2) | Klasse 3 | 3º ano EF |
| 9–10 | Série 4 | Year 5 | 4ª primária (Fase 4) | CM1 (C3) | Klasse 4 | 4º ano EF |
| 10–11 | Série 5 | Year 6 | 5ª primária (Fase 5) | CM2 (C3) | Klasse 5 (início da bifurcação) | 5º ano EF |
| 11–12 | Série 6 | Year 7 | 6ª primária (Fase 5) | 6e (C3) | Klasse 6 | 6º ano EF |
| 12–13 | Série 7 | Year 8 | 1ª secundária (Fase 6) | 5e (C4) | Klasse 7 | 7º ano EF |
| 13–14 | Série 8 | Year 9 | 2ª secundária (Fase 6) | 4e (C4) | Klasse 8 | 8º ano EF |
| 14–15 | Série 9 | Year 10 | 3ª secundária (Fase 6) | 3e (C4) | Klasse 9 | 9º ano EF |
| 15–18 | Séries 10–12 | Years 11–13 | Bachillerato | 2nde–Terminale | Klasse 10–12/13 (Gymnasium) | Ensino Médio |
...
| Números negativos | Brasil: alguma exposição informal via unidade “Números” antes dos inteiros formais | EUA: domínio The Number System (série 6, idade 11–12) [1]; Reino Unido tipicamente fim do KS2 / início do KS3 (idade 10–12) [3][4] | ~1–2 anos |
...
| Probabilidade/estatística | EUA: domínio Statistics and Probability a partir da série 6 [1] | Brasil: Probabilidade e Estatística corre como fio transversal em todo o Ensino Fundamental (idades 6–14) [17][18], portanto sem “idade de introdução” única | não comparável diretamente — modelos estruturais diferentes |
| Divisão de trilha/caminho | Alemanha: separação Gymnasium/Realschule/Hauptschule ~idade 10 [16] | EUA/UK/França/Brasil/Espanha: nenhuma bifurcação acadêmica formal antes de ~idade 14–15 (seleção de cursos no ensino médio) | a Alemanha é a exceção por 4–5 anos |
...
| Band | EN | ES | FR | DE | PT | Typical age | Core content |
|---|---|---|---|---|---|---|---|
...
1. Padrões Estaduais Comuns de Matemática (CCSSO). https://learning.ccsso.org/wp-content/uploads/2022/11/ADA-Compliant-Math-Standards.pdf  
2. Padrões Estaduais Comuns de Matemática, Apêndice A: Projetando Cursos de Matemática do Ensino Médio. https://web.ped.nm.gov/wp-content/uploads/_legacy/2025/04/CCSSI_Mathematics_Appendix_A.pdf  
3. Programas de estudo de Matemática: estágios‑chave 1 e 2, Currículo Nacional na Inglaterra (UK Department for Education). https://assets.publishing.service.gov.uk/media/5a7da548ed915d2ac884cb07/PRIMARY_national_curriculum_-_Mathematics_220714.pdf  
4. Programas de estudo de Matemática: estágio‑chave 3, Currículo Nacional na Inglaterra (UK DfE). https://assets.publishing.service.gov.uk/media/5a7c1408e5274a1f5cc75a68/SECONDARY_national_curriculum_-_Mathematics.pdf  
5. Programas de estudo de Matemática: estágio‑chave 4, Currículo Nacional na Inglaterra (UK DfE). https://assets.publishing.service.gov.uk/media/5a7dc9dced915d2ac884d8ef/KS4_maths_PoS_FINAL_170714.pdf  
6. Segundo aniversário do Plano de Estudos para a educação pré‑escolar, primária e secundária 2022 — Subsecretaria de Educação Básica (SEP). https://educacionbasica.sep.gob.mx/segundo-aniversario-del-plan-de-estudio-para-la-educacion-preescolar-primaria-y-secundaria-2022/  
7. Campo Formativo Saberes e Pensamento Científico: Resumo. https://docentesaldia.com/2023/03/19/campo-formativo-saberes-y-pensamiento-cientifico-resumen/  
8. As matemáticas no Plano e Programas de Estudo 2022 para a educação básica no México — SciELO. https://www.scielo.org.mx/scielo.php?script=sci_arttext&pid=S2448-80892022000100335  
9. Matemática: competências específicas, critérios de avaliação e saberes básicos — Ministério da Educação, FP e Desportos (España). https://educagob.educacionfpydeportes.gob.es/curriculo/curriculo-lomloe/menu-curriculos-basicos/ed-primaria/areas/matematicas/criterios-evaluacion-primer-ciclo.html  
10. Currículo LOMLOE: competências específicas — Fiquipedia. https://www.fiquipedia.es/home/legislacion-educativa/lomloe/curriculo-competencias-especificas/  
11. Ensinar no ciclo 3 — éduscol, Ministério da Educação Nacional (France). https://eduscol.education.gouv.fr/4356/enseigner-au-cycle-3  
12. O alicerce comum de conhecimentos, competências e cultura — éduscol. https://eduscol.education.gouv.fr/4761/le-socle-commun-de-connaissances-de-competences-et-de-culture  
13. Recursos de apoio ao programa de matemática no ciclo 4 — éduscol. https://eduscol.education.gouv.fr/5736/ressources-d-accompagnement-du-programme-de-mathematiques-au-cycle-4  
14. Padrões de Educação em Matemática (2022), Ensino Fundamental e Ensino Médio — KMK. https://www.kmk.org/fileadmin/Dateien/pdf/Bildung/Qualitaet/ImplBroschu__re_BiSta_MATHEMATIK_2023-03-23.pdf  
15. Padrões de Educação em Matemática para o Certificado de Ensino Médio — KMK (2003/2004). https://www.kmk.org/fileadmin/Dateien/veroeffentlichungen_beschluesse/2003/2003_12_04-Bildungsstandards-Mathe-Mittleren-SA.pdf  
16. Padrões de Educação em Matemática — Wikipedia (DE), resumindo a estrutura Leitideen da KMK. https://de.wikipedia.org/wiki/Bildungsstandards_Mathematik  
...
21. Matemática de Singapura — Wikipedia (abordagem CPA, estrutura P1–P6). https://en.wikipedia.org/wiki/Singapore_math  
22. Educação no Japão — Wikipedia (estrutura de séries e idades Shōgakkō/Chūgakkō/Kōkō). https://en.wikipedia.org/wiki/Education_in_Japan  
23. A Educação (Currículo Nacional) (Metas de Desempenho e Programas de Estudo em Matemática…) (Inglaterra) Ordem 2008 — legislation.gov.uk. https://www.legislation.gov.uk/uksi/2008/1759/article/2/made
