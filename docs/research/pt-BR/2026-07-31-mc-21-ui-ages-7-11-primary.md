...
> Pesquisa Math Challenge — 2026-07-31 — tópico 21
...
A faixa PRIMÁRIA (idades 7-11) está no estágio “operacional concreto” de Piaget: raciocínio lógico sobre objetos concretos mais “decentração” (atender a mais de uma dimensão ao mesmo tempo), mas ainda raciocínio abstrato fraco [1]. NN/g mostra que essa faixa navega de forma mais independente que pré-leitores de 3-5 anos, porém ainda rejeita conteúdo apresentado mesmo que esteja um nível de série fora [2]. Um estudo de avatares (arXiv, 48 participantes de 8-13 anos) documenta o “efeito armário”: crianças criam vários avatares, mas consistentemente se fixam em um só [4]. A pesquisa de adolescentes da NN/g (100 usuários de 13-17 anos, 210 sites) indica o teto que a PRIMÁRIA deve evitar tocar por baixo: adolescentes rejeitam a palavra “Kids” e o excesso de animação decorativa [3]. COPPA exige consentimento parental verificável para menores de 13 anos e restringe a coleta de dados, limitando diretamente qualquer recurso social nesta faixa [9]. A discalculia (5-10% da população) requer parear numerais com uma quantidade visual e evitar pressão de tempo [11]. Este relatório converte esses achados em uma especificação para o tema PRIMÁRIA, diferenciada de KINDER e TEEN, para telefone, tablet e desktop.
...
13. **Padrões de dispositivo: troca rápida de perfil sem digitação**, sem pressupor login pessoal persistente, para tablets familiares compartilhados ou Chromebooks escolares — um requisito inferido, não citado, dado o gap observado na §10.  
14. **Integração: pular a sequência de tutorial; ensinar através do primeiro problema real** com apoio embutido (primeira etapa trabalhada, botão de dica), correspondendo à baixa paciência desta faixa para atrasos [3] e à fraca retenção de instrução abstrata sem âncora concreta [1].
...
1. O PRIMARY deve suportar um **ranking com escopo de professor/sala de aula** além de um familiar, considerando que o requisito de consentimento da COPPA se aplica de forma diferente quando uma escola matricula a criança ao invés de um pai diretamente [9]?  
2. Qual é a posição do Math Challenge sobre **qualquer superfície de compra com dinheiro real** acessível a partir da experiência voltada ao CHILD do PRIMARY — ausente totalmente, ou presente atrás de um bloqueio parental sem mecânica aleatória?  
3. Os avatares devem ser **compartilhados/portáteis entre KINDER, PRIMARY e TEEN** à medida que a criança envelhece, ou cada faixa deve ter um sistema separado que corresponda à sua própria linguagem visual?  
4. Dado o efeito guarda-roupa [4], vale a pena **armazenar múltiplos avatares** ou o PRIMARY deve oferecer um único slot editável para corresponder ao uso real?  
5. O **alternador de tipografia amigável à dislexia** deve ser exposto diretamente à criança, ou configurado apenas por um pai/professor?  
6. O Math Challenge já possui um benchmark interno ou licenciado de **duração de sessão por idade** que deveria substituir o gap “nenhum dado encontrado” sinalizado aqui, ao invés de deixá-lo como decisão puramente de produto?

## Fontes

1. Wikipedia. “Piaget's theory of cognitive development” (estágio operacional concreto: conservação, raciocínio indutivo, descentração, limites no raciocínio abstrato).  
   https://en.wikipedia.org/wiki/Piaget%27s_theory_of_cognitive_development  
2. Nielsen Norman Group. “Children's UX: Usability Issues in Designing for Young People” (faixas etárias 3-5/6-8/9-12; rejeição por nível de série; preferência por animação; cegueira a anúncios).  
   https://www.nngroup.com/articles/childrens-websites-usability-issues/  
3. Nielsen Norman Group. “Teenagers' UX: Designing Websites for Teens” (100 usuários de 13-17 anos, 210 sites/30 apps; recomendação de leitura de 6ª série; “Kids” como repelente; baixa paciência; aversão a desordem).  
   https://www.nngroup.com/articles/usability-of-websites-for-teenagers/  
4. arXiv. “Understanding Children's Avatar Making in Social Online Games” (48 participantes de 8-13 anos; quatro motivações; o “efeito guarda-roupa”).  
   https://arxiv.org/abs/2502.18705  
5. Digital Wellness Lab. “Young People's Use of Avatars and Virtual Character Customization” (resumo de pesquisa sobre expressão de identidade, personalização de gênero, estatísticas de evitação de hipersexualização, preocupações com loot boxes).  
   https://digitalwellnesslab.org/research-briefs/young-peoples-use-of-avatars-and-virtual-character-customization/  
6. Frontiers in Virtual Reality. “Designing the Self: Avatar Customization, Identity, and Affective Experience” (82 participantes, estratificados por etnia; satisfação com personalização versus representação).  
   https://www.frontiersin.org/journals/virtual-reality/articles/10.3389/frvir.2026.1784948/full  
7. Nielsen Norman Group. “Young Users Usability Research Reports” (página de tópico: relatório 156-recommendation para crianças de 3-12 anos vs. relatório 124-tip para adolescentes de 13-17 anos).  
   https://www.nngroup.com/reports/topic/young-users/  
8. accessiBe. “Dyslexia-Friendly Fonts & Typography Best Practices” (escolha de fonte, mínimo 16 px, 1,5× altura de linha, espaçamento de 0,12 em entre letras, 0,16 em entre palavras, linhas de 45-100 caracteres, contraste WCAG 4.5:1/3:1).  
   https://accessibe.com/blog/knowledgebase/dyslexia-friendly-fonts  
9. Wikipedia. “Children's Online Privacy Protection Act” (limite de menores de 13 anos, definição de informação pessoal, consentimento parental verificável, restrição à coleta excessiva de dados).  
   https://en.wikipedia.org/wiki/Children%27s_Online_Privacy_Protection_Act  
10. Wikipedia. “Self-determination theory” (autonomia/competência/relacionamento; mecânicas de recompensa intrínseca vs. extrínseca).  
    https://en.wikipedia.org/wiki/Self-determination_theory  
11. Understood.org. “What Is Dyscalculia” (prevalência de 5-10%, dificuldade de senso de quantidade e mapeamento numeral, sensibilidade à pressão de tempo, recomendações de múltiplas entradas).  
    https://www.understood.org/en/articles/what-is-dyscalculia  
12. Apple Developer. Human Interface Guidelines — Accessibility (alvo tocável mínimo de 44×44 pt).  
    https://developer.apple.com/design/human-interface-guidelines/accessibility  

**Lacunas de evidência sinalizadas neste relatório** (nenhuma fonte consultada abordou isso especificamente para a faixa 7-11): benchmarks exatos de duração de sessão por idade; estudos sobre comprimento de tutorial de integração; medição de uso de tablets familiares compartilhados/Chromebooks escolares; um estudo dedicado de design de teclado numérico para essa idade. As implicações de design baseadas nessas lacunas estão marcadas como inferidas acima, não citadas como achado estabelecido.
