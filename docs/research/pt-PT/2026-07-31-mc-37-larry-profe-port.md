...
6. Tratar `effort` como um segundo eixo de roteamento independente da escolha do modelo; iniciar conservadoramente (`medium` no Opus 5) pois é a alavanca principal contra explosões de custos de tokens de pensamento.
