...
const CIERRE: Record<number, Especificacion[]> = {
  7: [
    ...
    { id: "cierre-n7-plantilla-03", clave: "cierre.operaciones", vars: { a: 2, b: 3, c: 4 }, respuesta: 10, errores: [14, 24, 9], tipo: "plantilla" },
  ...
  11: [
    ...
    { id: "cierre-n11-plantilla-02", clave: "cierre.proporcion", vars: { a: 7, c: 84 }, respuesta: 12, errores: [7, 19, 588], tipo: "plantilla" },
  ...
  12: [
    { id: "cierre-n12-fijo-01", clave: "cierre.ecuacion", vars: { a: 5, b: 7, c: 52 }, respuesta: 9, errores: [6, 8, 10], tipo: "fijo" },
    ...
    { id: "cierre-n12-plantilla-03", clave: "cierre.proporcion", vars: { a: 9, c: 135 }, respuesta: 15, errores: [9, 24, 1215], tipo: "plantilla" },
    { id: "cierre-n12-plantilla-04", clave: "cierre.operaciones", vars: { a: 6, b: 4, c: 3 }, respuesta: 27, errores: [18, 30, 10], tipo: "plantilla" },
  ],
};
