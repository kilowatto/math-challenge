...
KEYS=(
  ...
  "TURNSTILE_SECRET_KEY|Defensa de bots sobre el formulario público de registro (F2 #113). NO es verificación de edad ni biometría — no roza la línea roja #1|dash.cloudflare.com → Turnstile → math-challenge-turnstile-signup → Secret key"
)
